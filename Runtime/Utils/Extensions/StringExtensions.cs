...
namespace BlueCheese.Core
{
	public static class StringExtensions
	{
		...
		private static int LevenshteinDistance<T>(IEnumerable<T> lhs, IEnumerable<T> rhs) where T : System.IEquatable<T>
		{
			// Validate parameters
		...
		public static int LevenshteinDistance(this string lhs, string rhs, bool caseSensitive = true)
		{
			if (!caseSensitive)
			{
				lhs = lhs.ToLower();
